-- TPC-H schema for Postgres with explicit primary keys.
-- Primary keys are required because pg2iceberg (post-patch) fails on PK-less
-- tables, and iceberg-diff refuses to compare tables without a PK.
